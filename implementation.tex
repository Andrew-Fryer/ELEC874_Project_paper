...
AAAAAAAAAAAAAAAAHHHHHHHHHHHHH I'm an idiot!!!!
The reason it was going so slowly is that I was saving my model state so frequently and it is like 1.4 GB going over the network :|
\^wrong
I believe the reason is actually that SigNet256 is almost twice the size of SigNet128.
