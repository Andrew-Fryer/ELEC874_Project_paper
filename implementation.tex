...
It treats all dimensions with equal weight, whereas LeCun computes the mean and cov_mat of several genuine images and then computes p based on a gaussian/normal assumption.
