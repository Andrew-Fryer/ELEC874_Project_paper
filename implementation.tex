...
% the accuracy is actually much better for the adversarial case, but I don't feel like writing about it
\begin{figure}[h]
    \begin{center}
...
Figure \ref{fig:genuine} shows the genuine signature used for this expirement and figure \ref{fig:forge} shows the forge.
